...
<button type="button" class="btn btn-primary" data-toggle="modal"  data-target="#exampleModal<?= $datos->id ?>">
<img src="<?=base_url($datos->img)?>" class="img-thumbnail" alt="Responsive image"/></button>
